...
'''~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ DATA LOADING ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'''
def collab_filter_load_data():
	[user_ids, product_names, data_raw] = get_data()
	data = pd.DataFrame(data_raw)
	data.columns = product_names
	data.insert(0,'user',user_ids)
...
def item_collab_filter():
	data = collab_filter_load_data()
	data_raw = data.drop('user',1)
...
def user_collab_filter(): 
	data = collab_filter_load_data()
	data_raw = data.drop('user',1)
	[data_neighbours, data_ibs] = item_collab_filter()
